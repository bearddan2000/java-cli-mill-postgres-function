# java-cli-mill-postgres-function
...
implicit index on `dog_expanded`.id. Using an user defined function with the aggregate function
...
- [Search by gradle](https://github.com/bearddan2000?tab=repositories&q=java-cli-mill&type=&language=&sort=)
- [Search by postgres](https://github.com/bearddan2000?tab=repositories&q=java-cli-postgres&type=&language=&sort=)
- [Search by function](https://github.com/bearddan2000?tab=repositories&q=java-cli-function&type=&language=&sort=)
